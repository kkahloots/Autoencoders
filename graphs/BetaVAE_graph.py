...
class BVAEGraph(BaseGraph):
    ...
    def create_loss_optimizer(self):
        ...
        self.losses = ['Beta-VAE', 'VAE', 'AE', 'reconstruction', 'L2']
    ...
    def train_epoch(self, session, x):
        tensors = [self.train_step, self.bvae_loss, self.vae_loss, self.ae_loss, self.loss_reconstruction_m, self.L2_loss]
    ...
    def evaluate_epoch(self, session, x):
        tensors = [self.bvae_loss, self.vae_loss, self.ae_loss, self.loss_reconstruction_m, self.L2_loss]
        feed_dict = {self.x_batch: x}
